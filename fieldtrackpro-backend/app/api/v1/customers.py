...
async def create_customer(
    ...
    return await customer_service.create_customer(data, current_user.id, session)
...
async def list_customers(
    ...
    return await customer_service.list_customers(session, territory_id, skip, limit)
...
async def update_customer(
    ...
    return await customer_service.update_customer(customer_id, data, session)
